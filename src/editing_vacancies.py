class EditingVacancies:
    ...
    def __init__(self, name: str, alternate_url: str, salary_from: int, salary_to: int, currency: str,
    ...
    def __lt__(self, other):
        ...
        Возвращает:
            bool: True, если заработная плата текущей вакансии меньше, чем у другой, иначе False.
        """
